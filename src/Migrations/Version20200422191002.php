 ...
 */
final class Version20200422191002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE widget ADD position_top DOUBLE PRECISION NOT NULL, ADD position_left DOUBLE PRECISION NOT NULL, ADD data JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE widget DROP position_top, DROP position_left, DROP data');
    }
}
